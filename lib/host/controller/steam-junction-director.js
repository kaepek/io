...
export class StreamJunctionDirector {
    ...
    constructor(
        ...
        this.input_output_devices.forEach((input_output_device) => {
            input_output_device.bind_device_output_subject(this.device_output_subject); 
        });
    }
    ...
    handler_control_input (input) {
        ...
        // now process these words to the outputs. by calling the next on this.device_output_subject
    }
