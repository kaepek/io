...
class DualShockToTorqueSpeedModel extends InputToModelBase {
    ...
    gamepadArgs = null;
    scale = 1;
    state = { torque: 0, delay: 500, direction: true }; //cw 0 false / ccw 1 true
...
module.exports = { DualShockToTorqueSpeedModel }